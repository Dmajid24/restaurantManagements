    ...
    <aside class="w-64 bg-white p-4 border-r h-screen flex flex-col fixed top-0 left-0 overflow-y-auto">
        <div>
            ...
            <nav class="space-y-4">
                ...
                <a href="product" class="flex items-center space-x-2 text-green-600 font-semibold text-xl bg-green-50 px-2 py-1 rounded-lg">
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex flex-col md:flex-row gap-6">
          ...
          <div class="w-full md:w-1/3 bg-gray-200 rounded-lg h-64 flex items-center justify-center">
            <img src="https://via.placeholder.com/300x300?text=Product" alt="{{ $product->menuName }}" class="max-h-full max-w-full">
          </div>
