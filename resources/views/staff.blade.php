  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white p-4 border-r h-screen flex flex-col fixed top-0 left-0 overflow-y-auto">
        <div>
            ...
            <nav class="space-y-4">
                <a href="dashboard" class="flex items-center space-x-2 text-gray-700 font-semibold text-xl hover:text-green-600 transition">
                ...
                <a href="staff" class="flex items-center space-x-2 text-green-600 font-semibold text-xl bg-green-50 px-2 py-1 rounded-lg">
    ...
    <main class="flex-1 p-6 ml-64">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <button class="flex items-center space-x-2 bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg transition">
